import math
import sys
sys.stdout.write('Loading syserr_818ipbv12 ...')
## ----------------------------------------------------------
##  Systematic  Errors
## ----------------------------------------------------------
sys_err_by_mode = {
    0: {'ST Background modeling': 0.0038, #0.0059, #0.004,
        'Lepton veto'           : 0.001,
        'Delta E requirement'   : 0.001, #0.005,
        'Signal lineshape'      : 0.0040, #0.0029,
        'FSR'                   : 0.008, #0.0089,
        'Multiple candidates'   : 0.0
        },
    1: {'ST Background modeling': 0.0110, #0.012, #0.010,
        'Trigger simulation'    : 0.0,   #0.002,
        'Delta E requirement'   : 0.002, #0.005,
        'Signal lineshape'      : 0.005, #0.0135,
        'Resonant substructure' : 0.0058, #0.0052, #0.003,
        'FSR'                   : 0.004, #0.003,  #0.0034,
        'Multiple candidates'   : 0.007 #0.008
        },
    3: {'ST Background modeling': 0.0076, #0.0064,  #0.004,
        'Delta E requirement'   : 0.002, #0.001,   #0.005,
        'Signal lineshape'      : 0.0051, #0.005,   #0.0079,
        'Resonant substructure' : 0.013, #0.0121,  #0.012,
        'FSR'                   : 0.007, #0.006,   #0.0079,
        'Multiple candidates'   : 0.0
        },
    200: {'ST Background modeling': 0.0040, #0.0041, #0.004,
          'Delta E requirement'   : 0.001, #0.002,  #0.005,
          'Signal lineshape'      : 0.0034, #0.0033, #0.0032,
          'Resonant substructure' : 0.0053, #0.0052, #0.006,
          'FSR'                   : 0.005,  #0.0071,
          'Multiple candidates'   : 0.0
          },
    201: {'ST Background modeling': 0.0305, #0.0331, #0.015,
          'Delta E requirement'   : 0.002,  #0.005,
          'Signal lineshape'      : 0.0048, #0.0049, #0.0133,
          'Resonant substructure' : 0.0094, #0.0091, #0.005,
          'FSR'                   : 0.002,  #0.0031,
          'Multiple candidates'   : 0.002   #0.005
          },
    202: {'ST Background modeling': 0.0077, #0.0091, #0.004,
          'Trigger simulation'    : 0.0,    #0.001,
          'Delta E requirement'   : 0.0,    #0.001,  #0.005,
          'Signal lineshape'      : 0.0039, #0.004,  #0.0036,
          'FSR'                   : 0.004,  #0.0054,
          'Multiple candidates'   : 0.002
          },
    203: {'ST Background modeling': 0.0153, #0.0146,  #0.010,
          'Delta E requirement'   : 0.004,  #0.005,  #0.010,
          'Signal lineshape'      : 0.0048, #0.0047, #0.0049,
          'Resonant substructure' : 0.0042, #0.0078, #0.012,
          'FSR'                   : 0.002,  #0.0011,
          'Multiple candidates'   : 0.0
          },
    204: {'ST Background modeling': 0.0122, #0.0124, #0.010,
          'Delta E requirement'   : 0.012,  #0.010,  #0.005,
          'Signal lineshape'      : 0.0055, #0.0063,
          'Resonant substructure' : 0.0062, #0.0061, #0.005,
          'FSR'                   : 0.005,  #0.0058,
          'Multiple candidates'   : 0.0
          },
    205: {'ST Background modeling': 0.0082, #0.0080, #0.010,
          'Delta E requirement'   : 0.002,  #0.010,
          'Signal lineshape'      : 0.0054, #0.0055, #0.0060,
          'Resonant substructure' : 0.0582, #0.0185, #0.013,
          'FSR'                   : 0.003,  #0.0033,
          'Multiple candidates'   : 0       #0.002
          }}
