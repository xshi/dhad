"""
Providing Attributes of Backgrounds for BF fitter - Generic MC 
...
#BF for signal modes [in this case, in generic MC]
pdg_bf = {
    '0': 0.0382, #0.0389,
    '1': 0.135,  #0.139,
    '3': 0.0770, #0.0809,
...
bkg_pdg_bf = {
    'kpi': 1.4e-4, #1.48e-4,
    'kpipi0': 3.0e-4, #3.05e-4,
    'k3pi': 2.5e-4, #2.62e-4,
    'kkspi': 3.43e-3, #3.5e-3,
    'kkspibar': 2.63e-3, #2.6e-3,
    'kskspi': 6.2e-3, #1.6e-2,
    '3pi': 1042 ,#3031, #3021, #81,
    '3pipi0': 5827, # 16958, #10998, #188,
    '5pi': 4712 #13712  #8564 #117
    }
