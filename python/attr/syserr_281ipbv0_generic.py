...
## ----------------------------------------------------------
##  Systematic  Errors For Generic MC 
## ----------------------------------------------------------
sys_err_by_mode = {
    0: {'ST Background modeling': 0.004,
        'Lepton veto'           : 0.001,
        'Delta E requirement'   : 0.005,
        'Signal lineshape'      : 0.0029,
        'FSR'                   : 0.0089,
        'Multiple candidates'   : 0.0
        },
    1: {'ST Background modeling': 0.010,
        'Trigger simulation'    : 0.002,
        'Delta E requirement'   : 0.005,
        'Signal lineshape'      : 0.0135,
        'Resonant substructure' : 0.003,
        'FSR'                   : 0.0034,
        'Multiple candidates'   : 0.008
        },
    3: {'ST Background modeling': 0.004,
        'Delta E requirement'   : 0.005,
        'Signal lineshape'      : 0.0079,
        'Resonant substructure' : 0.012,
        'FSR'                   : 0.0079,
        'Multiple candidates'   : 0.0
        },
    200: {'ST Background modeling': 0.004,
          'Delta E requirement'   : 0.005,
          'Signal lineshape'      : 0.0032,
          'Resonant substructure' : 0.006,
          'FSR'                   : 0.0071,
          'Multiple candidates'   : 0.0
          },
    201: {'ST Background modeling': 0.015,
          'Delta E requirement'   : 0.005,
          'Signal lineshape'      : 0.0133,
          'Resonant substructure' : 0.005,
          'FSR'                   : 0.0031,
          'Multiple candidates'   : 0.005
          },
    202: {'ST Background modeling': 0.004,
          'Trigger simulation'    : 0.001,
          'Delta E requirement'   : 0.005,
          'Signal lineshape'      : 0.0036,
          'FSR'                   : 0.0054,
          'Multiple candidates'   : 0.002
          },
    203: {'ST Background modeling': 0.010,
          'Delta E requirement'   : 0.010,
          'Signal lineshape'      : 0.0049,
          'Resonant substructure' : 0.012,
          'FSR'                   : 0.0011,
          'Multiple candidates'   : 0.0
          },
    204: {'ST Background modeling': 0.010,
          'Delta E requirement'   : 0.005,
          'Signal lineshape'      : 0.0063,
          'Resonant substructure' : 0.005,
          'FSR'                   : 0.0058,
          'Multiple candidates'   : 0.0
          },
    205: {'ST Background modeling': 0.010,
          'Delta E requirement'   : 0.010,
          'Signal lineshape'      : 0.0060,
          'Resonant substructure' : 0.013,
          'FSR'                   : 0.0033,
          'Multiple candidates'   : 0.002
          }}
...
sys_err = {
    ...
    'charged pions' :                                       
    { 'fractional uncertainty' : 0.0025 , 'correction factor' : 1 },#0.995    },
    'charged kaons' :                                       
    { 'fractional uncertainty' : math.sqrt(0.003**2+0.006**2),
      'correction factor' : 1 }, #0.99},
    'electrons'  :                                          
...
#    { 'fractional uncertainty' : 0.018  , 'correction factor' : 1.00859933},
    'pi0' :                                                 
    { 'fractional uncertainty' : 0.02   , 'correction factor' : 1 }, #0.961    },
    'eta' :                                                 
    { 'fractional uncertainty' : 0.     , 'correction factor' : 1        }
