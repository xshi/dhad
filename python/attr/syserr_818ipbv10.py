import math
import sys
sys.stdout.write('Loading syserr_818ipbv10 ...')
## ----------------------------------------------------------
##  Systematic  Errors
## ----------------------------------------------------------
sys_err_by_mode = {
    0: {'ST Background modeling': 0.0059, #0.004,
        'Lepton veto'           : 0.001,
    ...
    1: {'ST Background modeling': 0.012, #0.010,
    ...
    3: {'ST Background modeling': 0.0064,  #0.004,
        'Delta E requirement'   : 0.001,   #0.005,
    ...
    201: {'ST Background modeling': 0.0331, #0.015,
          'Delta E requirement'   : 0.002,  #0.005,
    ...
    202: {'ST Background modeling': 0.0091, #0.004,
    ...
    203: {'ST Background modeling': 0.0146,  #0.010,
    ...
    204: {'ST Background modeling': 0.0124, #0.010,
