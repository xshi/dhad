...
from tools import parse_opts_set, create_bash_file_pyline
from tools.fits import mbc_single_3s, mbc_gau_che 
from tools.filetools import UserFile
from fit import load_roofit_lib, get_common_parameters, \
     get_resolution_paras, create_bash_file, init_paras_single
...
def fit_single_mode(datatype, mode, label, lowmass, highmass, test):
    ...
    mbc_single_3s(evtfile, mc, setMres, setGamma, setR, sigmap1, Sa, Sb, Fa,
