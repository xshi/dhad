...
void TGraph2DPainter::Paint(Option_t *option)
{
   ...
   if ((Hoption.Logx == 1 && fXmin <= 0) || (Hoption.Logx == 2 && fXmin < 0)) fXmin = xaxis->GetBinUpEdge(xaxis->FindFixBin(0.01*xaxis->GetBinWidth(first)));
   ...
   if ((Hoption.Logy == 1 && fYmin <= 0) || (Hoption.Logy == 2 && fYmin < 0)) fYmin = yaxis->GetBinUpEdge(yaxis->FindFixBin(0.01*yaxis->GetBinWidth(first)));
   ...
   if ((Hoption.Logz == 1 && fZmin <= 0) || (Hoption.Logz == 2 && fZmin < 0)) fZmin = TMath::Min((Double_t)1, (Double_t)0.001*gCurrentHist->GetMaximum());
...
void TGraph2DPainter::PaintPolyMarker(Option_t *option)
{
   ...
   for (it=0; it<fNpoints; it++) {
      ...
      //if (Hoption.Logy) temp1[1] = TMath::Log10(temp1[1]);
      //if (Hoption.Logz) temp1[2] = TMath::Log10(temp1[2]);
      if (Hoption.Logx == 1) temp1[0] = TMath::Log10(temp1[0]);
      else if (Hoption.Logx == 2) temp1[0] = TMath::Sqrt(temp1[0]);
      if (Hoption.Logy == 1) temp1[1] = TMath::Log10(temp1[1]);
      else if (Hoption.Logy == 2) temp1[1] = TMath::Sqrt(temp1[1]);
      if (Hoption.Logz == 1) temp1[2] = TMath::Log10(temp1[2]);
      else if (Hoption.Logz == 2) temp1[2] = TMath::Sqrt(temp1[2]);
      view->WCtoNDC(temp1, &temp2[0]);
      xm[it] = temp2[0];
      ym[it] = temp2[1];
   }
